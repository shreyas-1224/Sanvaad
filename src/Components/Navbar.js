...
function Navbar() {
    return (
        <nav className="navbar navbar-dark bg-dark navbar-expand-lg fixed-top py-4" id="mainNav" style={{ backgroundColor: "rgba(12, 186, 235, 0.5186449579831933)" }}  >
            <div className="container px-4 px-lg-5">
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive" style={{margin:"-70px"}}>
                    <ul className="navbar-nav ms-auto my-3 my-lg-0" style={{fontSize:"25px"}}>
                        ...
                        <li className="nav-item"><Link to='/sanvaad/realTime' className="nav-link" style={{paddingLeft:"30px"}}>real-time recognition</Link></li>
                    </ul>
                </div>
            </div>
        </nav>
